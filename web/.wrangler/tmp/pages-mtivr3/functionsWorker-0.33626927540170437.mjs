...
`.trim();
    ...
    console.log("[AI] RAW first 200:", cleaned.slice(0, 200));
    let arr = null;
    try {
      ...
      if (Array.isArray(parsed)) {
        arr = parsed;
      } else if (Array.isArray(parsed.milestones)) {
        arr = parsed.milestones;
      ...
      console.log("[AI] parse failed:", e.message);
...
async function callOpenAIWithRetry(apiKey, system, user, retries = 2) {
  let attempt = 0;
  let delay = 400;
  while (true) {
    ...
    return { ok: false, status: r.status, body: body ?? void 0 };
  }
}
...
__name(sleep, "sleep");
function M(title, offset, hrs, aTitle) {
  return { title, targetDate: iso(/* @__PURE__ */ new Date(), offset), estimateHrs: hrs, assessmentTitle: aTitle };
}
__name(M, "M");
function pct(days, p) {
  return Math.ceil(days * p);
}
__name(pct, "pct");
function iso(start, add) {
...
__name(extractFirstJson, "extractFirstJson");

// ../.wrangler/tmp/pages-mtivr3/functionsRoutes-0.25768888861506234.mjs
var routes = [
  {
...
// ../node_modules/.pnpm/wrangler@4.43.0_@cloudflare+workers-types@4.20251011.0/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../node_modules/.pnpm/wrangler@4.43.0_@cloudflare+workers-types@4.20251011.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@4.43.0_@cloudflare+workers-types@4.20251011.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-C4oBR8/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@4.43.0_@cloudflare+workers-types@4.20251011.0/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-C4oBR8/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.33626927540170437.mjs.map
