...
// .wrangler/tmp/pages-M2XLjd/functionsWorker-0.8850416376627144.mjs
...
var onRequestPost = /* @__PURE__ */ __name2(async ({ request, env }) => {
  try {
    ...
    const simple = [
      M("Topic & Research Plan", pct(days, 0.1), 2, assessment, today),
      M("Research & Notes", pct(days, 0.35), 6, assessment, today),
      M("First Draft", pct(days, 0.6), 6, assessment, today),
...
__name(sleep, "sleep");
__name2(sleep, "sleep");
function M(title, offset, hrs, assessment, start) {
  return {
    title,
...
// .wrangler/tmp/bundle-26Xip5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-26Xip5/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8850416376627144.js.map
